...
@property(nonatomic, strong) NSMutableArray *arrNewsItems;

@property(nonatomic,strong)NSArray *arrSelected;

@property(nonatomic,strong,readonly)NSMutableArray<Control_BezierPath *> *arrControl_BP;

@property(nonatomic,strong)void (^CBPBlock)(NSInteger index, NSDictionary *item);
